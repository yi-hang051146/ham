...
面向开发者和部署人员的技术文档，包含详细的技术说明、环境配置、API文档、构建命令等。
...
项目支持 GitHub Pages 子目录部署，无需修改路径配置。
...
**描述：** 修复手机访问 GitHub Pages 时思源笔记加载失败的问题

**关联问题：** 手机访问 GitHub Pages 时思源笔记加载失败（HTTP 404）

**根本原因：** 使用相对路径 `./data/siyuan`，在 GitHub Pages 子目录下路径不正确
